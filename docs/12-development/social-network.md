...
**Référence** : [docs/04-rails/pwa/README.md](../04-rails/pwa/README.md) — état PWA (étude archivée, validée)
...
- [docs/04-rails/pwa/README.md](../04-rails/pwa/README.md) – état PWA Grenoble Roller
