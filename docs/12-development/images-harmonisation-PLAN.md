...
- **Carrousel** : banner 16:9, `resize_to_fill` 1200×675, CSS cohérent — `[app/views/pages/_announcement_banner.html.erb](../../app/views/pages/_announcement_banner.html.erb)`, `[homepage-carousel.md](homepage-carousel.md)`.
- **Events** : variants historiques + consignes contradictoires — `[app/models/event.rb](../../app/models/event.rb)`, formulaires / ActiveAdmin.
- **Boutique** : Active Storage + fallback `image_url` — `[app/models/product.rb](../../app/models/product.rb)`, `[app/helpers/products_helper.rb](../../app/helpers/products_helper.rb)`, vues index/show.

---

## Référence vérifiée : carrousel (upload, preview admin, verrouillage CSS)

Pattern validé pour les surfaces **banner** — voir fichiers `[_form.html.erb` admin carrousel](../../app/views/admin_panel/homepage_carousels/_form.html.erb), `[carousel_form_controller.js](../../app/javascript/controllers/carousel_form_controller.js)`, `[_announcement_banner.html.erb](../../app/views/pages/_announcement_banner.html.erb)`, `[_style.scss](../../app/assets/stylesheets/_style.scss)` (`#announcementCarousel` : `aspect-ratio: 16/9`, cover centré).

---

## Documentation — pivot + satellites (éviter les contradictions)

**Pivot unique** : `[docs/04-rails/setup/image-formats-and-variants.md](../04-rails/setup/image-formats-and-variants.md)` — **seule** source pour : vocabulaire canonique, matrice surfaces, preview, phases `image_url`, décision story V1/V2, renvoi WebP/master.

**Satellites courts** (sans dupliquer la matrice complète) :

- `[active-storage-image-optimization.md](../04-rails/setup/active-storage-image-optimization.md)` : détails techniques events **ou** lien « détails dans le pivot ».
- `[homepage-carousel.md](homepage-carousel.md)` : fichiers, comportement feature, lien pivot.
- `[active-storage-minio-setup.md](../04-rails/setup/active-storage-minio-setup.md)` : infra.
- Optionnel FR : `[guide-images-benevoles.md](guide-images-benevoles.md)` — **doc canal** + safe zone ; pas de nouvelle « vérité » technique qui contredirait le pivot.
- `[docs/04-rails/setup/README.md](../04-rails/setup/README.md)` : lien vers le pivot en tête « Images ».
...
- Créer le **pivot** ; satellites = liens ; mettre à jour la doc admin boutique (voir [`../04-rails/admin-panel/README.md`](../04-rails/admin-panel/README.md)) : phases `image_url` + vocabulaire.
